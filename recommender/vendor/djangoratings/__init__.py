...
RatingField = lazy_object('recommender.vendor.djangoratings.fields.RatingField')
AnonymousRatingField = lazy_object('recommender.vendor.djangoratings.fields.AnonymousRatingField')
Rating = lazy_object('recommender.vendor.djangoratings.fields.Rating')
