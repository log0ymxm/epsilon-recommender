...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoGame.release_date_malformed'
        db.add_column(u'recommender_videogame', 'release_date_malformed',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoGame.release_date_malformed'
        db.delete_column(u'recommender_videogame', 'release_date_malformed')
