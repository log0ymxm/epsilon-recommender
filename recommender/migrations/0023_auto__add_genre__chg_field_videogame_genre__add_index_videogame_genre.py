...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Genre'
        db.create_table(u'recommender_genre', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')(unique=True)),
        ))
        db.send_create_signal(u'recommender', ['Genre'])


        # Renaming column for 'VideoGame.genre' to match new field type.
        db.delete_column(u'recommender_videogame', 'genre')
        # Changing field 'VideoGame.genre'
        db.add_column(u'recommender_videogame', 'genre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recommender.Genre'], null=True))


    def backwards(self, orm):
        # Removing index on 'VideoGame', fields ['genre']
        db.delete_index(u'recommender_videogame', ['genre_id'])

        # Deleting model 'Genre'
        db.delete_table(u'recommender_genre')


        # Renaming column for 'VideoGame.genre' to match new field type.
        db.delete_column(u'recommender_videogame', 'genre_id')
        # Changing field 'VideoGame.genre'
        db.add_column(u'recommender_videogame', 'genre', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
