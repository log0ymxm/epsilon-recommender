...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'recommender_feature', ['name'])

        # Adding unique constraint on 'Specification', fields ['name']
        db.create_unique(u'recommender_specification', ['name'])

        # Adding unique constraint on 'Platform', fields ['name']
        db.create_unique(u'recommender_platform', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Platform', fields ['name']
        db.delete_unique(u'recommender_platform', ['name'])

        # Removing unique constraint on 'Specification', fields ['name']
        db.delete_unique(u'recommender_specification', ['name'])

        # Removing unique constraint on 'Feature', fields ['name']
        db.delete_unique(u'recommender_feature', ['name'])
