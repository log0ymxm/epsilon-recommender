...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Specification.value'
        db.delete_column(u'recommender_specification', 'value')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Specification.value'
        raise RuntimeError("Cannot reverse this migration. 'Specification.value' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Specification.value'
        db.add_column(u'recommender_specification', 'value',
