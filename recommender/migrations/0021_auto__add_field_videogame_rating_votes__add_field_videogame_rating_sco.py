...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoGame.rating_votes'
        db.add_column(u'recommender_videogame', 'rating_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'VideoGame.rating_score'
        db.add_column(u'recommender_videogame', 'rating_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoGame.rating_votes'
        db.delete_column(u'recommender_videogame', 'rating_votes')

        # Deleting field 'VideoGame.rating_score'
        db.delete_column(u'recommender_videogame', 'rating_score')
