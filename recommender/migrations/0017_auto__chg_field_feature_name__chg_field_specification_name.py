...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'recommender_feature', 'name', self.gf('django.db.models.fields.TextField')(unique=True))

        # Changing field 'Specification.name'
        db.alter_column(u'recommender_specification', 'name', self.gf('django.db.models.fields.TextField')(unique=True))

    def backwards(self, orm):

        # Changing field 'Feature.name'
        db.alter_column(u'recommender_feature', 'name', self.gf('django.db.models.fields.CharField')(max_length=512, unique=True))

        # Changing field 'Specification.name'
        db.alter_column(u'recommender_specification', 'name', self.gf('django.db.models.fields.CharField')(max_length=512, unique=True))
