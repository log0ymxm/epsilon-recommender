...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'recommender_genre', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'VideoGame.genre_slug'
        db.delete_column(u'recommender_videogame', 'genre_slug')


    def backwards(self, orm):
        # Deleting field 'Genre.slug'
        db.delete_column(u'recommender_genre', 'slug')


        # User chose to not deal with backwards NULL issues for 'VideoGame.genre_slug'
        raise RuntimeError("Cannot reverse this migration. 'VideoGame.genre_slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'VideoGame.genre_slug'
        db.add_column(u'recommender_videogame', 'genre_slug',
