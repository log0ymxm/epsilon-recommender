...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoGameAttribute.value'
        db.alter_column(u'recommender_videogameattribute', 'value', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'VideoGameAttribute.value'
        db.alter_column(u'recommender_videogameattribute', 'value', self.gf('django.db.models.fields.CharField')(max_length=255))
