...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'recommender_userprofile', 'bio')

        # Adding field 'UserProfile.gender'
        db.add_column(u'recommender_userprofile', 'gender',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.location'
        db.add_column(u'recommender_userprofile', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.date_of_birth'
        db.add_column(u'recommender_userprofile', 'date_of_birth',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.about_you'
        db.add_column(u'recommender_userprofile', 'about_you',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field platforms_owned on 'UserProfile'
        m2m_table_name = db.shorten_name(u'recommender_userprofile_platforms_owned')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'recommender.userprofile'], null=False)),
            ('platform', models.ForeignKey(orm[u'recommender.platform'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'platform_id'])


    def backwards(self, orm):
        # Adding field 'UserProfile.bio'
        db.add_column(u'recommender_userprofile', 'bio',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.gender'
        db.delete_column(u'recommender_userprofile', 'gender')

        # Deleting field 'UserProfile.location'
        db.delete_column(u'recommender_userprofile', 'location')

        # Deleting field 'UserProfile.date_of_birth'
        db.delete_column(u'recommender_userprofile', 'date_of_birth')

        # Deleting field 'UserProfile.about_you'
        db.delete_column(u'recommender_userprofile', 'about_you')

        # Removing M2M table for field platforms_owned on 'UserProfile'
        db.delete_table(db.shorten_name(u'recommender_userprofile_platforms_owned'))
    ...
    models = {
        ...
        u'recommender.userprofile': {
            ...
            'platforms_owned': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['recommender.Platform']", 'null': 'True', 'blank': 'True'}),
