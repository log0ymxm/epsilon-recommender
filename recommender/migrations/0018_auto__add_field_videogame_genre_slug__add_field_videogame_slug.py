...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VideoGame.slug'
        db.delete_column(u'recommender_videogame', 'slug')
